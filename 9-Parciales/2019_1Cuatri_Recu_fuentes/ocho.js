function mostrar()
{
	...
	do
	{
		...
		{
			if(peso<pesoMinimoBajoCero&&temperatura<0)
			{
				pesoMinimoBajoCero=peso;
			}
			if(peso>pesoMaximoBajoCero&&temperatura<0)
			{
				pesoMaximoBajoCero=peso;
			}
		}
	...
	document.write("<br>El animal m{as pesado es el/la "+animalMasPesado+" y vive a una temperatura de "+temperaturaMasPesado);
